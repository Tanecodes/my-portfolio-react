    ...
    <div className="hero">
      ...
      <div className="introWrapper">
        ...
        <p>
          ...
          but my GitHub is pretty active from all my commits showing in the contributions graph. If you visit my GitHub you can see
          all my work or you can just check out my projects section here on my webpage.
        </p>  
      </div>
      <div>
